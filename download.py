...
def _download_audio(x):
    ...
    ydl_opts = {
        ...
        "postprocessors": [ # ffmpeg -i xx.webm -ss xx -to xx xx.wav
            {
    ...
    with YoutubeDL(ydl_opts) as ydl:
        ydl.download([f"https://www.youtube.com/watch?v={ytid}"]) # # https://www.youtube.com/watch?v=-0Gj8-vB1q4
...
if __name__ == "__main__":
    ytid = "-0Gj8-vB1q4"
    start, end = 30, 40
    out_dir = "/mnt/nas/users/lsj/music/sft_data/audio"
